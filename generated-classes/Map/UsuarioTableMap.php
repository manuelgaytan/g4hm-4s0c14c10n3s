...
class UsuarioTableMap extends TableMap
{
    ...
    /**
     * the column name for the fecha_ultimo_acceso field
     */
    const COL_FECHA_ULTIMO_ACCESO = 'usuario.fecha_ultimo_acceso';

    /**
     * the column name for the root_asociacion field
     */
    const COL_ROOT_ASOCIACION = 'usuario.root_asociacion';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Usuario', 'Contrasena', 'FechaUltimoAcceso', 'RootAsociacion', ),
        self::TYPE_CAMELNAME     => array('id', 'usuario', 'contrasena', 'fechaUltimoAcceso', 'rootAsociacion', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID, UsuarioTableMap::COL_USUARIO, UsuarioTableMap::COL_CONTRASENA, UsuarioTableMap::COL_FECHA_ULTIMO_ACCESO, UsuarioTableMap::COL_ROOT_ASOCIACION, ),
        self::TYPE_FIELDNAME     => array('id', 'usuario', 'contrasena', 'fecha_ultimo_acceso', 'root_asociacion', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Usuario' => 1, 'Contrasena' => 2, 'FechaUltimoAcceso' => 3, 'RootAsociacion' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'usuario' => 1, 'contrasena' => 2, 'fechaUltimoAcceso' => 3, 'rootAsociacion' => 4, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID => 0, UsuarioTableMap::COL_USUARIO => 1, UsuarioTableMap::COL_CONTRASENA => 2, UsuarioTableMap::COL_FECHA_ULTIMO_ACCESO => 3, UsuarioTableMap::COL_ROOT_ASOCIACION => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'usuario' => 1, 'contrasena' => 2, 'fecha_ultimo_acceso' => 3, 'root_asociacion' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('fecha_ultimo_acceso', 'FechaUltimoAcceso', 'DATE', false, null, null);
        $this->addColumn('root_asociacion', 'RootAsociacion', 'BOOLEAN', false, 1, null);
    } // initialize()
    ...
    {
        $this->addRelation('Integrante', '\\Integrante', RelationMap::ONE_TO_MANY, array('id' => 'fk_usuario', ), null, null, 'Integrantes');
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_FECHA_ULTIMO_ACCESO);
            $criteria->addSelectColumn(UsuarioTableMap::COL_ROOT_ASOCIACION);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.usuario');
            $criteria->addSelectColumn($alias . '.contrasena');
            $criteria->addSelectColumn($alias . '.fecha_ultimo_acceso');
            $criteria->addSelectColumn($alias . '.root_asociacion');
        }
    }
