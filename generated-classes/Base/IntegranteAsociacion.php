...
/**
 * Base class that represents a row from the 'integrante_asociacion' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class IntegranteAsociacion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\IntegranteAsociacionTableMap';
    ...
    /**
     * Initializes internal state of Base\IntegranteAsociacion object.
     */
    ...
    /**
     * Compares this with another <code>IntegranteAsociacion</code> instance.  If
     * <code>obj</code> is an instance of <code>IntegranteAsociacion</code>, delegates to
     * <code>equals(IntegranteAsociacion)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|IntegranteAsociacion The current object, for fluid interface
     */
     ...
     * @return $this|\IntegranteAsociacion The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[IntegranteAsociacionTableMap::COL_ID] = true;
        }
    ...
    public function setFkAsociacion($v)
    {
        ...
        if ($this->fk_asociacion !== $v) {
            ...
            $this->modifiedColumns[IntegranteAsociacionTableMap::COL_FK_ASOCIACION] = true;
        }
    ...
    public function setFkIntegrante($v)
    {
        ...
        if ($this->fk_integrante !== $v) {
            ...
            $this->modifiedColumns[IntegranteAsociacionTableMap::COL_FK_INTEGRANTE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : IntegranteAsociacionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : IntegranteAsociacionTableMap::translateFieldName('FkAsociacion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_asociacion = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : IntegranteAsociacionTableMap::translateFieldName('FkIntegrante', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = IntegranteAsociacionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\IntegranteAsociacion'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildIntegranteAsociacionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see IntegranteAsociacion::setDeleted()
     * @see IntegranteAsociacion::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildIntegranteAsociacionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                IntegranteAsociacionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(IntegranteAsociacionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(IntegranteAsociacionTableMap::COL_FK_ASOCIACION)) {
            $modifiedColumns[':p' . $index++]  = 'fk_asociacion';
        }
        if ($this->isColumnModified(IntegranteAsociacionTableMap::COL_FK_INTEGRANTE)) {
            $modifiedColumns[':p' . $index++]  = 'fk_integrante';
        }

        $sql = sprintf(
            'INSERT INTO integrante_asociacion (%s) VALUES (%s)',
    ...
    {
        $pos = IntegranteAsociacionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['IntegranteAsociacion'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['IntegranteAsociacion'][$this->hashCode()] = true;
        $keys = IntegranteAsociacionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\IntegranteAsociacion
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(IntegranteAsociacionTableMap::COL_ID)) {
            $criteria->add(IntegranteAsociacionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(IntegranteAsociacionTableMap::COL_FK_ASOCIACION)) {
            $criteria->add(IntegranteAsociacionTableMap::COL_FK_ASOCIACION, $this->fk_asociacion);
        }
        if ($this->isColumnModified(IntegranteAsociacionTableMap::COL_FK_INTEGRANTE)) {
            $criteria->add(IntegranteAsociacionTableMap::COL_FK_INTEGRANTE, $this->fk_integrante);
        }
    ...
    {
        $criteria = ChildIntegranteAsociacionQuery::create();
        $criteria->add(IntegranteAsociacionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \IntegranteAsociacion (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \IntegranteAsociacion Clone of current object.
     * @throws PropelException
     */
    ...
    public function setIntegrante(ChildIntegrante $v = null)
    {
        ...
        if ($v !== null) {
            $v->addIntegranteAsociacion($this);
        }
    ...
    public function getIntegrante(ConnectionInterface $con = null)
    {
        if ($this->aIntegrante === null && ($this->fk_integrante !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aIntegrante->addIntegranteAsociacions($this);
             */
        }
    ...
    public function getAsociacion(ConnectionInterface $con = null)
    {
        if ($this->aAsociacion === null && ($this->fk_asociacion !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAsociacion->addIntegranteAsociacions($this);
             */
        }
    ...
    {
        if (null !== $this->aIntegrante) {
            $this->aIntegrante->removeIntegranteAsociacion($this);
        }
        if (null !== $this->aAsociacion) {
            $this->aAsociacion->removeIntegranteAsociacion($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(IntegranteAsociacionTableMap::DEFAULT_STRING_FORMAT);
    }
