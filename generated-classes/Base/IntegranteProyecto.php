...
/**
 * Base class that represents a row from the 'integrante_proyecto' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class IntegranteProyecto implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\IntegranteProyectoTableMap';
    ...
    /**
     * Initializes internal state of Base\IntegranteProyecto object.
     */
    ...
    /**
     * Compares this with another <code>IntegranteProyecto</code> instance.  If
     * <code>obj</code> is an instance of <code>IntegranteProyecto</code>, delegates to
     * <code>equals(IntegranteProyecto)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|IntegranteProyecto The current object, for fluid interface
     */
     ...
     * @return $this|\IntegranteProyecto The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[IntegranteProyectoTableMap::COL_ID] = true;
        }
    ...
    public function setFkIntegrante($v)
    {
        ...
        if ($this->fk_integrante !== $v) {
            ...
            $this->modifiedColumns[IntegranteProyectoTableMap::COL_FK_INTEGRANTE] = true;
        }
    ...
    public function setFkProyecto($v)
    {
        ...
        if ($this->fk_proyecto !== $v) {
            $this->fk_proyecto = $v;
            $this->modifiedColumns[IntegranteProyectoTableMap::COL_FK_PROYECTO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : IntegranteProyectoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : IntegranteProyectoTableMap::translateFieldName('FkIntegrante', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_integrante = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : IntegranteProyectoTableMap::translateFieldName('FkProyecto', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = IntegranteProyectoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\IntegranteProyecto'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildIntegranteProyectoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see IntegranteProyecto::setDeleted()
     * @see IntegranteProyecto::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildIntegranteProyectoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                IntegranteProyectoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(IntegranteProyectoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(IntegranteProyectoTableMap::COL_FK_INTEGRANTE)) {
            $modifiedColumns[':p' . $index++]  = 'fk_integrante';
        }
        if ($this->isColumnModified(IntegranteProyectoTableMap::COL_FK_PROYECTO)) {
            $modifiedColumns[':p' . $index++]  = 'fk_proyecto';
        }

        $sql = sprintf(
            'INSERT INTO integrante_proyecto (%s) VALUES (%s)',
    ...
    {
        $pos = IntegranteProyectoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['IntegranteProyecto'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['IntegranteProyecto'][$this->hashCode()] = true;
        $keys = IntegranteProyectoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getFkIntegrante(),
            $keys[2] => $this->getFkProyecto(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\IntegranteProyecto
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setFkIntegrante($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setFkProyecto($arr[$keys[2]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(IntegranteProyectoTableMap::COL_ID)) {
            $criteria->add(IntegranteProyectoTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(IntegranteProyectoTableMap::COL_FK_INTEGRANTE)) {
            $criteria->add(IntegranteProyectoTableMap::COL_FK_INTEGRANTE, $this->fk_integrante);
        }
        if ($this->isColumnModified(IntegranteProyectoTableMap::COL_FK_PROYECTO)) {
            $criteria->add(IntegranteProyectoTableMap::COL_FK_PROYECTO, $this->fk_proyecto);
        }
    ...
    {
        $criteria = ChildIntegranteProyectoQuery::create();
        $criteria->add(IntegranteProyectoTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \IntegranteProyecto (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \IntegranteProyecto Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProyecto(ConnectionInterface $con = null)
    {
        if ($this->aProyecto === null && ($this->fk_proyecto !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProyecto->addIntegranteProyectos($this);
             */
        }
    ...
    public function getIntegrante(ConnectionInterface $con = null)
    {
        if ($this->aIntegrante === null && ($this->fk_integrante !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aIntegrante->addIntegranteProyectos($this);
             */
        }
    ...
    {
        if (null !== $this->aProyecto) {
            $this->aProyecto->removeIntegranteProyecto($this);
        }
        if (null !== $this->aIntegrante) {
            $this->aIntegrante->removeIntegranteProyecto($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(IntegranteProyectoTableMap::DEFAULT_STRING_FORMAT);
    }
